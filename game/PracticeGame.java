...
public class PracticeGame
{
    public static void main(String[]args)
    {
        ...
        *If there's options, you just type whatever the prompt asks. If there are multiple options, type whatever the option is word for word.
        ...
        System.out.println("If options are presented, type your choice word for word. Options are case sensitive and require punctuation");
        keyboard.nextLine();
        ...
        String purpose = keyboard.nextLine();
            ...
            else if(purpose.equals("I don't know"))
            {
                System.out.println("");
            ...
            else if(purpose.equals("What's it to you?"))
            {
               System.out.println("");
        ...
        keyboard.nextLine();
        System.out.println("Sprite: Ah, yeah... your clothes were a bit dirty, so I decided to wash them! Do all humans look like that down there? Yuck! Anyways, let me find you some more clothes. I tried washing yours and... well... apparently fairy detergent doesn't work so well on human clothes. Who knew, right?");
        keyboard.nextLine();
        ...
        String begPath = keyboard.nextLine();
                ...
                if (strangePotions.equals("Yes"))
            {
               ...
               else if(strangePotions.equals("No"))
               {
                ...
                System.out.println("");
                System.out.println("Nope, not a thing.    /    You're right, that's a touchy subject...    /    Kiss me and I might consider telling");
                System.out.println("");
                ...
                else if(touchy.equals("You're right, that's a touchy subject..."))
                {
                ...
                else if (touchy.equals("Kiss me and I might consider telling"))
                {
                ...
                keyboard.nextLine();
                System.out.println("You arrive in the village");
